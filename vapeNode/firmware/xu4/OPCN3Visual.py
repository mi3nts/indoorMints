...
def animateOPCN3(i):
    # try:
        ...
        if(validOPCN3):
            ...
            legendsIn     = [dateTimePatchOPCN3,pm1Patch,pm2_5Patch,pm10Patch,dateTimePatchBME280,temperaturePatch,humidityPatch,pressurPatch]
            ...
            ax1.set_title("Particle Distribution data(OPCN3) with Generic Environmental data(BME280) " )
